...
```{r, echo = F, eval   = F}
# Esto tengo que correr para que ande knitr
library(slidify)
library(slidifyLibraries)

# Opciones de YAML descartadas
...
knitr::include_graphics('assets/img/diagrama1.png')
```
...
knitr::include_graphics('assets/img/diagrama2.png')
```
...
```{r, echo=FALSE, out.width = "70%"}
knitr::include_graphics('assets/img/diagrama3.png')
```
